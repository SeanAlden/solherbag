  ...
  <section class="bg-white w-full">
      ...
      <div class="mx-auto max-w-[1600px]">
        ...
        <div class="flex gap-4 overflow-x-auto scrollbar-hide">
          ...
          >
            ...
            <div class="text-left">
              <h4 class="mb-1 text-[10px] text-gray-500 md:text-xs uppercase tracking-widest">
                {{ product.name }}
              </h4>
    ...
    <div class="px-6 pb-24 w-full">
      <div class="mx-auto max-w-[1600px]">
        <div class="flex justify-between items-end mb-10">
          <h3 class="font-serif font-light text-gray-800 text-3xl md:text-4xl italic">
        ...
        <div class="flex gap-4 overflow-x-auto scrollbar-hide">
          ...
          >
            ...
            <div class="text-left">
              <h4 class="mb-1 text-[10px] text-gray-500 uppercase tracking-widest">
                {{ product.name }}
              </h4>
    ...
    <div class="relative w-full h-[300px] md:h-[500px] overflow-hidden">
      ...
      <div class="absolute inset-0 flex items-end bg-black/10 p-8 md:p-16">
        <h2 class="max-w-md font-serif font-light text-white text-2xl md:text-5xl">
