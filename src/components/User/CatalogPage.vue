  ...
  <div class="relative bg-[#F3F4F6] px-6 md:px-12 pt-12 pb-24 min-h-screen">
    ...
    <div v-if="paginatedProducts.length > 0">
      ...
      >
        ...
        >
          <div
            class="relative bg-white shadow-sm mb-4 rounded-sm aspect-square overflow-hidden"
          >
            <img
              :src="product.image"
              class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
          ...
          <div class="space-y-1">
            <h3
              class="font-medium text-[10px] text-gray-900 md:text-xs truncate uppercase tracking-widest"
            >
              {{ product.name }}
            </h3>
